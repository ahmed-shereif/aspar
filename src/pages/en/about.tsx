...
export default function About() {
  return (
    <>
      <Head>
        <title>About | Aspar for packaging solutions</title>
        <meta name="description" content={"aspar is a leading Saudi Arabian packaging company that specializes in tailoring end-to-end solutions to your business's unique needs."} />
        <meta property="og:title" content={"About"} />
        <meta property="og:description" content={"aspar is a leading Saudi Arabian packaging company that specializes in tailoring end-to-end solutions to your business's unique needs."} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.asparpackaging.com/en/about" />
      </Head>
      <motion.main animate={{opacity:1}} initial={{opacity:0.8}} transition={TRANS} className="lg:pt-[4.5rem] overflow-x-hidden flex justify-center bg-primary relative text-white flex-wrap">
        <div className="screen-optz w-full min-h-screen px-12 2xl:px-0 lg:px-24  ">
          <div className="flex lg:py-20 lg:h-[35rem] flex-wrap lg:flex-nowrap">
            <div className="bg-white w-full lg:w-1/2 absolute top-0 h-80 lg:h-[calc(35rem+4.5rem)] left-0" ></div>
            <div className="w-full lg:w-1/2 flex z-40 h-80  relative ">
              ...
              <div className="lg:pl-8 pl-2 w-2/3 flex justify-start flex-wrap items-center text-primary  font-a">
            ...
            <motion.div  viewport={{ once: true }}  whileInView={{ x: [100,0] }} transition={TRANS} className="w-full lg:w-1/2 text-white lg:py-12 2xl:px-24 lg:px-12 mt-8 lg:mt-0 text-xl lg:text-2xl text-justify">  
                <span className="text-error font-medium relative italic">
                  aspar
                </span> is a leading Saudi Arabian packaging company that specializes in tailoring end-to-end solutions to your business's unique needs. 
            </motion.div>
          </div>
          <div className="flex flex-col-reverse lg:flex-row py-16 flex-wrap lg:flex-nowrap">
            <motion.div  viewport={{ once: true }}  whileInView={{ x: [-100,0] }} transition={TRANS} className="w-full lg:w-1/2 flex flex-col justify-around text-xl lg:text-2xl mt-8 lg:mt-0 text-justify lg:pr-12 2xl:pr-0 ">
              <div className="w-full ">
                We believe that every product deserves to be packaged in a way that captures its essence and appeals to its intended audience. That's why we work closely with our clients to craft    that align with their visual identity and product pricing. Our team of experts will listen to your ideas, design the packaging, manufacture it with precision, and deliver it to your doorstep. We take pride in our attention to detail and commitment to excellence, ensuring that every aspect of the packaging process is seamless and stress-free for our clients. 
              </div>
            </motion.div>
          ...
          <div className="flex lg:flex-row lg:py-16 flex-wrap lg:flex-nowrap">
            ...
            <motion.div  viewport={{ once: true }}  whileInView={{ x: [100,0] }} transition={TRANS} className="w-full lg:w-1/2 flex flex-col justify-around text-xl lg:text-2xl mt-8 lg:mt-0 ">
              ...
              <div className="w-full">At Aspar, we believe that your packaging is a crucial component of your brand's success, and we're passionate about helping you make a lasting impression on your customers.</div>
              <div className="w-full mt-4 lg:mt-12">We understand that all brands in Saudi Arabia often struggle to find premium packaging solutions that accurately reflect their product quality and brand identity. Aspar provides accessible and customized packaging solutions tailored to your unique needs and budget. Our talented professionals are dedicated to delivering exceptional service and packaging solutions that help your brand make a lasting impression on your customers</div>
            </motion.div>
          </div> 
          <div className="py-16">
            <div className="w-full text-error font-black text-xl lg:text-2xl ">Problems you face:</div>
            <motion.div  viewport={{ once: true }}  whileInView={{ opacity:[0,1] , y: [-50,0] }} transition={TRANS} className="flex relative my-8 lg:mt-16 justify-around flex-wrap lg:flex-nowrap ">
              ...
              <div className="my-4 lg:my-0 h-48 w-48 lg:h-64 lg:w-64 flex justify-center items-center border-[1.5rem] border-white bg-error  text-lg lg:text-xl font-black text-white  rounded-full p-4 shadow-2xl">
                <div className="text-center">
          ...
          <div className="lg:py-16">
            <div className="w-full text-error font-black text-xl lg:text-2xl ">Additional services: </div>
            <div className="flex flex-wrap relative my-8 justify-around  text-xl lg:text-2xl ">
              <motion.div  viewport={{ once: true }}  whileInView={{ x: [-100,0] }} transition={TRANS}  className="w-full lg:w-1/2 py-8 pr-8">
                <div className="font-bold">Storage:<span className="text-error font-black"> FREE</span></div>
                <div className="mt-8 lg:mt-16">Aspar provides storage solutions for businesses that require additional space to store their packages. Our facilities are secure, climate-controlled, and monitored around the clock to ensure the safety and integrity of your packages.</div>
              </motion.div>
              <motion.div  viewport={{ once: true }}  whileInView={{ x: [100,0] }} transition={TRANS}  className="w-full lg:w-1/2 py-8 pl-8">
                <div className="font-bold">Golden guarantee:<span className="text-error font-black"> FREE</span></div>
                <div className="mt-8 lg:mt-16">We stand behind the quality of our packaging solutions at Aspar, and offer a refund guarantee for any manufacturing quality issues, with the condition that you keep the packages. Trust Aspar to deliver exceptional service and high-quality customized packaging solutions that meet and exceed your expectations.</div>
              </motion.div>
        ...
        <div className="lg:py-20 w-full bg-white flex justify-center ">
          <div className="screen-optz px-12">
            <div className="flex flex-wrap py-16">
              ...
              <motion.div  viewport={{ once: true }}  whileInView={{ x: [100,0] }} transition={TRANS} className="w-full lg:w-1/2 flex flex-col justify-around text-xl lg:text-2xl text-black font-medium ">
                <div className="text-error font-black my-4 lg:m-0">What does Aspar mean?</div>
                <div>Aspar is an Arabic word that means appearance and looks, and that's what we do here.</div>
                <div className="text-error font-black my-4 lg:m-0">How can you do all that with such a low price?</div>
                <div>Aspar collaborates with specialized factories around the world to deliver exceptional packaging solutions that are tailored to our client's unique needs and reflect our commitment to their success.</div>
                <div>At Aspar, all of our packaging solutions are eco-friendly, reflecting our commitment to sustainability and the environment.</div>
              </motion.div>
