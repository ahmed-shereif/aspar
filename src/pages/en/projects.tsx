...
const SLIDER_DATA_A = [
  { id: 441, src: '/c-1-h.jpg' },
  { id: 442, src: '/c-1-h.jpg' },
...
export default function Projects() {
  ...
  return (
    <>
      ...
      <motion.main className="overflow-x-hidden lg:pt-20 lg:p-0 mb-4 bg-primary">
        ...
        <section className=' flex lg:min-h-screen justify-center flex-wrap bg-white'>
          ...
          <div className='w-full mt-5'>
            <motion.div viewport={{ once: true }} whileInView={{ x: isMobile ? [50, 0] : [100, 0], opacity: [0, 1] }} transition={{ delay: 0.1, ...TRANS }} initial={{ opacity: 0 }} className='h-80 lg:h-[62vh]  min-w-full  overflow-hidden'>
