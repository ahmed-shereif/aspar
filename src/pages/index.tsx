...
const PROCESS_DATA = [
  {id:1,name:'meeting',image:'meeting.svg'},
  {id:2,name:'desgin',image:'design.svg'},
  {id:3,name:'present',image:'present.svg'},
  {id:4,name:'manufacturing',image:'manufacturing.svg'},
  {id:5,name:'quailty check',image:'qc.svg'},
  {id:6,name:'delivery',image:'delivery.svg'},
]
        ...
        <section className='flex lg:min-h-screen justify-center flex-wrap lg:pt-20'>
          <div className='w-full screen-optz px-12 lg:px-24 lg:py-12 py-8 2xl:py-24  2xl:px-12 flex flex-wrap overflow-x-hidden '>
            ...
            <motion.div animate={{x:[50,0]}} transition={TRANS}  className='w-full lg:w-1/2 lg:pl-20'>
              <div className='font-black text-4xl lg:text-6xl 2xl:text-8xl text-primary lg:mb-10 2xl:mb-20 uppercase lg:normal-case my-4 '>welcome  ,</div>
              <div className='lg:mt-10 2xl:mb-20  font-black text-3xl lg:text-5xl 2xl:text-6xl text-primary  my-4'>JOIN US</div>
              <div className='text-3xl lg:text-4xl 2xl:text-6xl max-w-md lg:leading-[5rem] text-black font-semibold'>AND GET THE BEST SERVICE</div>
              <div className=' uppercase text-info mb-4 text-right max-w-md font-medium'>Aspar Team</div>
              <div className='text-center  my-4'>
                <Link href='/contact' className='btn btn-primary hover:text-primary shadow-xl h-16 text-white  border-transparent rounded-full px-8 '>
          ...
          <div className='screen-optz w-full  px-12 lg:px-24 lg:py-12 py-8 2xl:py-24  2xl:px-12 '>
            ...
            <div className='flex justify-center lg:justify-end'>
              <a href='https://www.facebook.com/' className='btn font-bold hover:border-white shadow-xl hover:text-white bg-white h-16 text-primary  border-transparent rounded-full px-8 '>
                <div className='w-28 '>Download Our Catalog</div>
          ...
          <div className='screen-optz w-full px-12 lg:px-24 lg:py-12 py-8   2xl:px-12 '>
            <div className='w-full lg:pb-12 mb-8 flex justify-center '>
              <div className=' px-4 py-8 rounded-full border-2  border-white h-full '>
                <span className=' shadow-2xl text-2xl lg:text-4xl border-2 px-12 py-4 uppercase rounded-full bg-white text-primary font-medium font-b border-transparent '>Our Process</span>              
              </div>
            </div>            
            <div className='flex flex-wrap lg:gap-32 justify-between'>
              {
                PROCESS_DATA.map(procs =>(
                  <motion.div whileInView={{opacity:[0,1]}}  viewport={{ once: true }} transition={TRANS}   key={procs.id} className='w-[45%] lg:w-1/5'>
                    ...
                    <div className='bg-white w-full rounded-full my-4 text-center text-primary text-sm lg:text-2xl py-4 font-semibold capitalize'> {procs.name}</div>
                  </motion.div>
                ))
              }
            ...
            <div className='flex justify-center lg:justify-end mt-20  '>
              <Link href='/process' className='btn bg-white hover:text-white shadow-xl h-20 text-primary  border-transparent rounded-full px-8 lg:px-16 '>
