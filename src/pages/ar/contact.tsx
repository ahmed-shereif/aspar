...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>تواصل معنا | أسبار</title>
        <meta name="description" content={"أرسل لنا إيميل أو نقطة في الواتس!"} />
        <meta property="og:title" content={"تواصل معنا"} />
        <meta property="og:description" content={"أرسل لنا إيميل أو نقطة في الواتس!"} />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.asparpackaging.com/ar/contact" />          
      </Head>
      <motion.main dir="rtl" animate={{opacity:1}} initial={{opacity:0.8}} transition={{ease:'linear',duration:0.5}} className="bg-neutral min-h-screen lg:pt-32 py-12 flex justify-center">
      <div className='w-full lg:w-1/2 h-[25rem] lg:h-full absolute top-20 lg:top-0 left-0 bg-white flex justify-center items-center'>
        </div>
        <div className="screen-optz z-40 -mt-10 lg:mt-0 w-full px-12 lg:px-0 flex flex-wrap justify-center content-start">
          <motion.div animate={{y:[-50,0],opacity:[0,1]}} transition={TRANS}  className="bg-white w-full lg:w-5/12 px-8 py-6 h-min font-b text-center rounded-full text-lg lg:text-3xl text-neutral font-semibold shadow-lg"> أرسل لنا إيميل أو نقطة في الواتس!</motion.div>
          <div className="flex flex-wrap overflow-hidden flex-col-reverse lg:flex-row w-full"> 
            <motion.div animate={{x:[-100,0]}} transition={TRANS} className="w-full lg:w-1/2 mt-12 lg:mt-10 text-center">
              <div className='mb-10 lg:mb-12 flex justify-center'>
                <div className='flex text-white border-2 border-white w-min px-2 py-2 rounded-2xl '>
                  ...
                  <div className=' w-40 justify-center flex items-center'>
                    <div className='uppercase px-4 text-3xl tracking-widest font-light'>الإيميل</div>
                  </div>
              ...
              <div className='mb-10 lg:mb-12 flex justify-center'>
                <div className='flex text-white border-2 border-white w-min px-2 py-2 rounded-2xl '>
                  ...
                  <div className='flex items-center w-40  justify-center'>
                    <div className='uppercase px-4 text-3xl tracking-widest font-light'>الواتس</div>
                  </div>

                </div>                
              </div>
              <div dir="ltr" className='mb-10 lg:mb-12 text-white underline font-black text-lg lg:text-4xl tracking-wider'>
              ...
              <div className='mb-10 lg:mb-12 flex justify-center'>
                <div className='flex text-white border-2 border-white w-min px-2 py-2 rounded-2xl '>
                  ...
                  <div className='flex items-center w-40  justify-center'>
                    <div className='uppercase px-4 text-3xl tracking-widest font-light'>الانستا</div>
                  </div>
            ...
            <motion.div dir="ltr" animate={{x:[100,0]}} transition={TRANS} className="w-full lg:w-1/2 h-[20rem] lg:h-full ">
